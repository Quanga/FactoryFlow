  ...
  try {
    const result = await emailClient.sendEmail({
      ...
      HtmlBody: `
        ...
        <p>An attendance infringement has been recorded.</p>
        <table style="border-collapse: collapse; width: 100%; max-width: 500px;">
          <tr>
            <td style="padding: 8px; border: 1px solid #ddd;"><strong>Employee Name:</strong></td>
            <td style="padding: 8px; border: 1px solid #ddd;">${data.employeeName}</td>
        ...
        <p style="margin-top: 20px;">This notification was automatically generated by FactoryFlow Attendance System.</p>
      `,
      TextBody: `
